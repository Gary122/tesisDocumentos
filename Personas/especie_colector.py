# -*- coding: utf-8 -*-
"""
Created on Thu Jun  8 01:18:58 2023
...
df = pd.read_excel('C:/Users/Cristobal/Desktop/ScripTesis/Personas/especie_colector.xlsx')
...
for index, row in df.iterrows():
    ...
    query = "INSERT INTO especie_colector (esp_id, col_id) VALUES (%s, %s)"
    cur.execute(query, (int(row['esp_id']), int(row['col_id'])))
