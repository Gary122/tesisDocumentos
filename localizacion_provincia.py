# -*- coding: utf-8 -*-
"""
Created on Thu Jun  8 19:30:21 2023
...
df = pd.read_excel('C:/Users/Cristobal/Desktop/ScripTesis/localizacion_provincia.xlsx')
...
for index, row in df.iterrows():
    ...
    query = "INSERT INTO localizacion_provincia (loc_id, pro_id) VALUES (%s, %s)"
    cur.execute(query, (int(row['loc_id']), int(row['pro_id'])))
